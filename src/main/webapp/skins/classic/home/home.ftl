...
<div class="tabs-sub fn-clear">
    <a pjax-title="${articleLabel} - ${user.userName}" href="${servePath}/member/${user.userName}"<#if type == "home"> class="current"</#if>>${articleLabel}<#if type == "home"> &nbsp;<span class="count">${paginationRecordCount?c}</span></#if></a>
