<div class="footer">
    <div class="wrapper">
        <div class="slogan">
            ${indexIntroLabel} &nbsp; &nbsp;
            <a href="https://github.com/xingdong015" target="_blank" class="tooltipped tooltipped-n" aria-label="${siteCodeLabel}">
        ...
        <div class="fn-flex-1">
            <#--<div class="footer-nav fn-clear">-->
                ...
                <#--&lt;#&ndash;<a href="https://hacpai.com/article/1457158841475">API</a>&ndash;&gt;-->
